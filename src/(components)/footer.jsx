...
export default function Footer() {
    return (
        <footer className="bg-pink-100 rounded-lg shadow dark:bg-pink-600 dark:text-slate-900 m-4">
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 dark:text-inherit sm:mb-0 dark:text-gray-400">
                        <li>
                            <a
                                href="/#product-us"
                ...
                <span className="block text-sm text-gray-500 sm:text-center dark:text-inherit">
                    © 2023
